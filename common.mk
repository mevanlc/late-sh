...
# Makefile / Makefile2 select the environment template and check database.
# .env is a verbatim copy of a committed template (.env.dev, or .env.dev2 for a parallel
...
.PHONY: .env-instance2
.env-instance2:
	@$(MAKE) -f Makefile2 .env

.PHONY: start-instance2
start-instance2:
	@$(MAKE) -f Makefile2 start
...
.PHONY: arena
arena:
	$(MAKE) -f $(firstword $(MAKEFILE_LIST)) test-llm ARGS="-p late-ssh --run-ignored all -j1 -E 'test(lateania::svc::arena)'"
