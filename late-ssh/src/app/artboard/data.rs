...
fn brushes_lines() -> Vec<String> {
    [
        ...
        "",
        "Slot 1 is the live clipboard swatch. Ctrl+C / Ctrl+X refresh it and immediately arm the fresh result as your brush.",
        "",
        ...
        "  Space / Esc        dismiss the floating brush",
        "",
        "Transparency",
        "  swatch and sampled brushes start transparent, so blank cells pass through the canvas underneath.",
        "",
        "Swatch management (mouse)",
        "  click pin icon     pin / unpin a slot (slots 2+)",
