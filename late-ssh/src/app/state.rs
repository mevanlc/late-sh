...
pub struct App {
    ...
    pub(crate) show_viz_config_modal: bool,
    pub(crate) viz_config_modal_state: viz_config_modal::state::VizConfigModalState,
...
impl App {
    ...
    pub fn new(config: SessionConfig) -> anyhow::Result<Self> {
        ...
        let mut app = Self {
            ...
            show_viz_config_modal: false,
            viz_config_modal_state: viz_config_modal::state::VizConfigModalState::new(),
